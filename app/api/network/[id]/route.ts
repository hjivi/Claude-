...
const ALLOWED_FIELDS = [
  "name", "email", "phone", "company", "connection_source", "last_interaction", "discussion_notes",
] as const;
...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  if ("last_interaction" in update && update.last_interaction === "") update.last_interaction = null;
